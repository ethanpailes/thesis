...
\renewcommand{\thesisauthor}{Your Full Name}    %% Your name.
...
\renewcommand{\thesistitle}{This is the title of my thesis}

                                     %% The title of your thesis; use
                                     %% mixed-case.

\renewcommand{\thesisauthorpreviousdegrees}{BS, MS, Tufts; LLD, DC\&H}
                                     %% Your previous degrees, abbreviated;
                                     %% separate multiple degrees by commas.

\renewcommand{\thesissupervisor}{Prof. Knuffle Bunny}
...
\renewcommand{\thesiscommitteemembera}{Prof. Computer Scientist2}
\renewcommand{\thesiscommitteememberb}{Prof. Computer Scientist3}
...
\renewcommand{\thesisauthoraddress}{Halligan Hall\\
Tufts University\\
161 College Ave.
Medford, MA 02155}
